...
const NAV_LINKS = [
  { label: "Home", link: "#" },
  { label: "Search", link: "#features" },
  { label: "Students", link: "#features" },
  { label: "Sit-in", link: "#features" },
  { label: "View Sit-in Records", link: "#features" },
  { label: "Sit-in Reports", link: "#features" },
