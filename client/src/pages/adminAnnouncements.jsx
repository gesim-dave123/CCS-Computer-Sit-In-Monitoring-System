    ...
    <main className="min-h-screen bg-slate-50 text-slate-800 p-4 sm:p-6 md:pl-72">
      ...
      <section className="max-w-7xl mx-auto mt-16 md:mt-0 space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
          <div className="xl:col-span-4 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden h-fit">
            ...
            <form onSubmit={submitAnnouncement} className="p-5 space-y-4">
              ...
              <button
                type="submit"
                disabled={saving}
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-purple-600 text-white hover:bg-purple-700 disabled:opacity-60"
              >
              ...
              {editingAnnouncementId && (
                <button
                  type="button"
                  onClick={cancelEdit}
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-slate-300 text-slate-700 hover:bg-slate-100"
                >
                  Cancel Edit
                </button>
              )}
            ...
            <div className="px-5 py-4 border-b border-slate-200 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="w-full lg:w-auto grid grid-cols-1 sm:grid-cols-3 gap-2">
                <input
                  ...
                  className="sm:col-span-3 lg:col-span-1 w-full border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-300"
                />

                <select
                  value={priorityFilter}
                  onChange={(e) => setPriorityFilter(e.target.value)}
                  className="w-full border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-300"
                >
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase">
                          <span className="px-2 py-1 rounded-full bg-white/80 text-slate-700">
                            {item.type}
                          </span>
                          <span className="px-2 py-1 rounded-full bg-white/80 text-slate-700">
                            {item.priority}
                          </span>
                          <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-white/80 text-slate-700">
                      ...
                      <div className="w-full sm:w-auto sm:min-w-[190px] sm:shrink-0 text-xs text-slate-500 space-y-1 gap-1">
